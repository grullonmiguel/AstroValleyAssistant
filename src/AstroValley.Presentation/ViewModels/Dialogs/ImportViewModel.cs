...
public partial class ImportViewModel : DialogViewModelBase<List<PropertyRecord>>
{
    ...
    {
        ["ParcelId"] = ["parcel", "parcelid", "pid", "parcelnumber"],
        ["Address"] = ["address", "siteaddress", "location", "street" , "parcellocation"],
        ["Owner"] = ["owner", "ownername", "owner name"],
        ["Bid"] = ["minimumbid", "minimunbid", "openingbid", "startingbid", "amountdue"],
        ["Assessed"] = ["assessed", "assessedvalue", "appraised", "appraisedvalue"],
    ...
    public string? SelectedFilePath
    {
        ...
        set
        {
            ...
            {
                LoadIntoGridCommand.NotifyCanExecuteChanged();
            }
        }
    }
    ...
    [RelayCommand(CanExecute = nameof(CanClearGrid))]
    ...
    [RelayCommand(CanExecute = nameof(CanLoadIntoGrid))]
    private async Task LoadIntoGrid()
    {

...
public partial class MarkerMapView : UserControl
{
    ...
    private async void OnMarkersCollectionChanged(object? sender, NotifyCollectionChangedEventArgs e)
    {
        ...
        switch (e.Action)
        {
            case NotifyCollectionChangedAction.Add:
                ...
                var newItems = e.NewItems?.Cast<MarkerLocation>();
    ...
    private async Task PushMarkersToJs(IEnumerable<MarkerLocation> locations, bool clearExisting)
    {
    ...
    {
        if (e.AddedItems.Count > 0 && e.AddedItems[0] is MarkerLocation selected)
        {
